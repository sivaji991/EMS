const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-emerald-900 relative overflow-hidden border-r border-slate-200">

      <div className="absolute -top-20 -left-20 w-72 h-72 bg-green-700/50 rounded-full blur-3xl"></div>
