        ...
        <div className="w-full max-w-md  animate-fade-in">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="siva123@example.com" />
            </div>
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-linear-to-r from-emerald-600 to-emerald-400 text-white rounded-md text-sm font-semibold hover:from-emerald-600 hover:to-emerald-500 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-green-500/25 active:scale-[0.95] flex items-center justify-center"
            >
