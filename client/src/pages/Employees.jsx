...
const Employees = () => {
  ...
  const fetchEmployees = useCallback(async()=>{
    setLoading(true);
    setEmployees(dummyEmployeeData.filter((emp)=>(selectDept ? employees.deptName === selectDept : emp)))
    setTimeout(()=>{
      setLoading(false)
    },1000)
  },[selectDept])
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          <Search className="absolute left-3.5 top-1/2 transform -translate-1/2 text-slate-400 w-4 h-4" />
        ...
        onClick={()=>setShowCreateModal(false)}>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e)=>e.stopPropagation()}>
            <div className="flex items-center justify-between p-6 pb-0">
              <div>
                <h2 className="text-lg font-medium text-slate-900">Add New Employee</h2>
