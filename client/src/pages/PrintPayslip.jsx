        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-slate-300">
              <th className="text-left py-3 px-4 text-xs text-slate-600 uppercase tracking-wider">Description</th>
              <th className="text-right py-3 px-4 text-xs text-slate-600 uppercase tracking-wider">Amount</th>
            </tr>
          </thead>
          <tbody>
